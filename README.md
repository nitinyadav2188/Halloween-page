## 🎃 Spooky Season is Here – Halloween Landing Page  
...
## 🕸️ Live Demo  
🎯 **Check it out here:** [Click Here](https://nitinyadav2188.github.io/Halloween-page/)  

💻 **GitHub Repository:** [Halloween Page](https://github.com/nitinyadav2188/Halloween-page)
...
- 🌫️ Animated fog overlay using SVG  
- 🦇 Flying bats and a ghost that floats across the screen  
- 🎃 Pumpkins that react to clicks  
- 💥 Explosion effect revealing a hidden monster  
- 🕷️ Randomly falling spiders  
...
- **CSS3** – Animations, gradients, fog, and glowing effects  
- **JavaScript (ES6)** – Interactive explosions and dynamic elements  
- **Google Fonts** – Using *Creepster* and *Nosifer* for Halloween typography  
